...
export const providers: ProviderDescriptor[] = [
  ...
  { key: 'supabase', name: 'Supabase database and storage', category: 'storage', envVars: ['NEXT_PUBLIC_SUPABASE_URL', 'NEXT_PUBLIC_SUPABASE_ANON_KEY', 'SUPABASE_SERVICE_ROLE_KEY'], status: statusFor(['NEXT_PUBLIC_SUPABASE_URL', 'NEXT_PUBLIC_SUPABASE_ANON_KEY', 'SUPABASE_SERVICE_ROLE_KEY']), notes: 'Production persistence, auth, and secure document storage.' },
